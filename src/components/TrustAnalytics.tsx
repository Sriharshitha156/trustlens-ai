...
import DataFeedsHealthPanel from "./features/DataFeedsHealthPanel";
...
export default function TrustAnalytics() {
  const { data, orgMetrics, feedbackAnalytics, outcomeStats } = useAppData();
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="mx-auto max-w-7xl space-y-6 px-5 py-6 lg:px-8">
        ...
        <DataFeedsHealthPanel
          evidenceWeights={data.evidenceWeights}
          trustLedger={data.trustLedger}
        />
